        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-4">Suadiye Mahallesi, Bağdat Caddesi, Kadıköy/İstanbul</p>
              <h3 className="text-xl font-semibold mb-4">Opening Hours</h3>
              <p className="text-gray-600 mb-4">
                Monday - Sunday: 09:00 - 23:00
              </p>
              <h3 className="text-xl font-semibold mb-4">Contact Information</h3>
              <p className="text-gray-600">Phone: +90 (216) XXX XX XX</p>
              <p className="text-gray-600">Email: info@rebornsuadiye.com</p>
              <div className="mt-6">
                <a 
