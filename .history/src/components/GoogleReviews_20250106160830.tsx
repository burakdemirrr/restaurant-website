...
const reviews: Review[] = [
  {
    ...
    author: "Mehmet Y.",
    rating: 5,
    text: "One of the best places on Bagdat Avenue. The breakfast is especially amazing, everything is very fresh and delicious. The jams served at breakfast are homemade. The staff is very attentive and friendly.",
    date: "2024-01-15"
  },
  {
    id: 2,
    author: "Ayse K.",
    rating: 5,
    text: "Worth visiting just for the San Sebastian cheesecake! The brunch menu is very rich, especially the avocado toast is my favorite. The view and ambiance are great, do not forget to make a reservation.",
    date: "2024-01-10"
  },
  {
    id: 3,
    author: "Can S.",
    rating: 5,
    text: "We chose it for dinner and were very satisfied. The grilled sea bass and risotto were amazing. The desserts were equally successful. We will definitely come back.",
    date: "2024-01-05"
  }
]
